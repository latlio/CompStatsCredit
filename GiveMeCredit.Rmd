...
cs_training <- cs_training %>%
  mutate(Distributedincome = MonthlyIncome/(1+NumberOfDependents)-1,
         ...
         RUULIncome = log(RevolvingUtilizationOfUnsecuredLines/MonthlyIncome), #Housing Insolvency paper
         HousingExpenses = log(NumberRealEstateLoansOrLines/MonthlyIncome),
         AgeCubed = age^3,
         LogAge = log(age)
)
```
